...
def sake_metric(predicted_features_gallery, gt_labels_gallery, predicted_features_query, gt_labels_query, k=None):
    ...
    # predicted_features_query = predicted_features_query.cpu()
    # predicted_features_gallery = predicted_features_gallery.cpu()
    # gt_labels_query = gt_labels_query.cpu()
    # gt_labels_gallery = gt_labels_gallery.cpu()
